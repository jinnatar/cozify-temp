...
def _initXDG(program_name):
    # per the XDG basedir-spec we adhere to $XDG_CONFIG_HOME if it's set,
    # otherwise assume $HOME/.config
    xdg_config_home = ""
    ...
    # XDG base-dir: "If, when attempting to write a file, the destination directory
    # is non-existant an attempt should be made to create it with permission 0700.
